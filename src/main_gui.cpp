...
int main(int argc, char* argv[]) {
    std::cout << "Starting ESP32 Driver IDE (GUI Version)...\n\n";
    
    try {
        // Create backend components using the same API
        ...
        // Connect backend components to UI (same API as terminal version)
